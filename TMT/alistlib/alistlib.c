...
//khai báo hàm rỗng
// a1,a2,a3... an => nếu n =0 thì danh sách rỗng
...
int getAt(Position p, List L){
    return L.elements[p-1]; //vị trí của ptu trong ds bắt đầu từ 0, theo thứ tự là từ 1 nên phải trừ ra
}
